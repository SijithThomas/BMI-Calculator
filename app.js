...
bmiHeads.forEach(bmiHead=>{
    bmiHead.addEventListener('click',()=>{
        ...
        if(bmiHead.id === 'bmi-si-head'){
            removeActiveClass();
            bmiHead.classList.add('active-head');
            bmiUsc.classList.remove('show-bmi');
            bmiSi.classList.add('show-bmi');
            activeForm="bmi-si";
        }
    })
})
